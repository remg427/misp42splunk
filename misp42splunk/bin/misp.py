...
class ModInputmisp(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputmisp, self).__init__("misp42splunk", "misp", use_single_instance)
    ...
    def get_scheme(self):
        ...
        """
        scheme.add_argument(smi.Argument("misp_url", title="MISP url",
                                         description="provide MISP URL. Do not end with a /",
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("misp_key", title="MISP API key",
                                         description="provide one authkey for the instance",
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("misp_verifycert", title="Check MISP certificate",
                                         description="",
        ...
        scheme.add_argument(smi.Argument("misp_use_proxy", title="Use proxy settings",
                                         ...
                                         required_on_create=False,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("client_use_cert", title="Use a client certificate",
                                         description="Use a client certificate to authenticate on default instance",
                                         required_on_create=False,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("client_cert_full_path", title="Client certificate file ",
